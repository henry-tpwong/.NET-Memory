...
#### **理解 GC heap memory 使用量與 process/機器 memory 使用量的關係**
...
#### **長時間 pause 是由 ephemeral GC、full blocking GC 或 BGC 引起？**
...
#### 「我完全沒有修改程式碼，為何升級 .NET 版本後看到 memory 使用量增加？」
...
#### 我們正在收集 GC 中時間百分比的 counter，顯示為 99%。我們該如何解決效能問題？
